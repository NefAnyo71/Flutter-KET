                            ...
                            columns: [
                              DataColumn(
                                label: ConstrainedBox(
                                  constraints: BoxConstraints(
                                    minWidth: isWideScreen ? 200 : 150,
                                    maxWidth: isWideScreen ? 250 : 200,
                                  ),
                                  child: Text('E-posta'),
                                ),
                            ...
                            rows: _paginatedUsers.map((user) {
                              ...
                              return DataRow(
                                color: MaterialStateProperty.resolveWith<Color?>(
                                    ...
                                    if (isBlocked) return Colors.red[50];
                                    return null;
                                  },
                                ),
                                cells: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          tooltip: isBlocked ? 'Engeli Kaldır' : 'Kullanıcıyı Engelle',
                                        ),
                                      ],
                                    ),
                                  ),
